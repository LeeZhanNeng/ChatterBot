    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-0">
                ...
                <div class="card-header border-0" style="background-color: transparent; text-align: center; font-size: 50px">{{ __('Welcome Back') }}</div>
                    ...
                    <form action="{{ route('userLogin') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @endif
                                or
                                    <a class="btn btn-link" href="{{ route('userRegister') }}">{{ __('Sign Up For New Account') }}</a>
                            </div>
                        </div>
